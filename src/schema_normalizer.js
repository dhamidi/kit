	...
	return {
		...
		properties: {
			...
			description:
				...
				Type.Optional(
					Type.String({
						description: 'Component description shown in listings (default: generated by the provider)',
					}),
				),
			files:
...
function optionalStringSchema() {
	return Type.Optional(Type.String({ description: 'Extra planning context for follow-up agent work' }))
}
